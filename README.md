...
Installer scripts are generated by CD and attached to GitHub Releases.

macOS/Linux:

```bash
# latest release
curl -fsSL https://github.com/ilypopv/sede/releases/latest/download/install.sh | bash

# specific release tag
curl -fsSL https://github.com/ilypopv/sede/releases/download/v0.1.0/install.sh | bash
```

Windows (PowerShell):

```powershell
curl.exe -fsSL https://github.com/ilypopv/sede/releases/latest/download/install.ps1 -o install-sede.ps1
powershell -NoProfile -ExecutionPolicy Bypass -File .\install-sede.ps1

# specific release tag
curl.exe -fsSL https://github.com/ilypopv/sede/releases/download/v0.1.0/install.ps1 -o install-sede.ps1
powershell -NoProfile -ExecutionPolicy Bypass -File .\install-sede.ps1
```
